    ...
    if (!user) {
        return (
            <div className="min-h-[60vh] pt-32 pb-20 container mx-auto px-6 text-center">
                <h1 className="text-3xl font-serif text-gray-900 mb-4">{t('title')}</h1>
                <p className="text-gray-600 mb-8">{t('loginToView')}</p>
            ...
            <div className="container mx-auto px-6">
                ...
                {displayedProducts.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm">
                        ...
                        <h2 className="text-2xl font-serif text-gray-900 mb-2">{t('empty')}</h2>
