  ...
  return (
    <div className="min-h-screen container mx-auto px-4 py-12 pb-32 md:pb-12">
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-pink-100">
          ...
          return (
            <div key={key} className="flex flex-col md:grid md:grid-cols-6 gap-4 p-4 md:p-6 border-b border-gray-100 items-start md:items-center">
              ...
              <div className="flex justify-between items-center w-full md:w-auto md:justify-center mt-2 md:mt-0">
                <span className="md:hidden text-sm font-medium text-gray-600">Qty:</span>
        ...
        {/* Cart Summary */}
        <div className="p-6 md:p-8 bg-pink-50 flex flex-col md:flex-row justify-between items-center md:items-end gap-6 md:gap-0">
          <Link href="/" className="text-pink-600 hover:text-pink-800 font-medium hover:underline text-center md:text-left order-2 md:order-1">
            ← Continue Shopping
          </Link>
          <div className="flex flex-col items-center md:items-end w-full md:w-auto order-1 md:order-2">
            <p className="text-lg text-gray-600 mb-1 md:mb-2 text-center md:text-right w-full">Subtotal</p>
            <p className="text-2xl md:text-4xl font-bold text-pink-700 mb-4 md:mb-6 text-center md:text-right w-full">${getTotalPrice().toFixed(2)}</p>
            <button
