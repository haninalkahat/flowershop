            ...
            <div className="container mx-auto px-6 max-w-6xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    <div className="bg-white rounded-3xl p-8 border border-pink-100 shadow-xl shadow-pink-50/50">
                        <h2 className="text-2xl font-serif font-bold text-gray-900 mb-6">{t('sendMessage')}</h2>
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <button
                                ...
                                className="w-full bg-gray-900 text-white font-bold py-4 rounded-xl hover:bg-pink-600 transition-all duration-300 shadow-lg shadow-gray-200 hover:shadow-pink-200 flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed"
                            >
                                <span>{isSubmitting ? t('sending') : t('send')}</span>
                                {!isSubmitting && <Send className="w-4 h-4 group-hover:translate-x-1 rtl:group-hover:-translate-x-1 transition-transform" />}
                            </button>
                        </form>
                    </div>
                    ...
                    <div className="flex flex-col space-y-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <h3 className="font-bold text-gray-900 mb-1">{t('whatsapp')}</h3>
                                <p className="text-gray-600 text-sm break-all" dir="ltr">+90 551 639 50 25</p>
                            </a>
                            ...
                            <div className="group flex flex-col items-center justify-center p-6 bg-pink-50/50 rounded-2xl border border-pink-100 hover:bg-pink-100/50 transition-colors text-center">
                                ...
                                <p className="text-gray-600 text-sm break-all">laffashopstore@gmail.com</p>
                            </div>

                            <a
                                href="https://instagram.com/laffa.shopstore"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            >
                                ...
                                <p className="text-gray-600 text-sm">@laffa.shopstore</p>
                            </a>
