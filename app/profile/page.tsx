                    ...
                    <div className="flex-1">
                        {activeTab === 'profile' && (
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                                <h1 className="text-2xl font-bold font-serif text-gray-900 mb-6">Profile Details</h1>
                        ...
                        {activeTab === 'security' && (
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                                <h1 className="text-2xl font-bold font-serif text-gray-900 mb-6">Security</h1>
                        ...
                        {activeTab === 'questions' && (
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                                <h1 className="text-2xl font-bold font-serif text-gray-900 mb-6">My Questions & Messages</h1>
                        ...
                        {activeTab === 'orders' && (
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                                <h1 className="text-2xl font-bold font-serif text-gray-900 mb-6">My Orders</h1>
                                {ordersLoading ? (
                                    <p>Loading orders...</p>
                                ) : orders.length === 0 ? (
                                    <div className="text-center py-12">
                                        <p className="text-gray-500 mb-4">No orders found.</p>
                                        <Link href="/shop" className="text-pink-600 font-bold hover:underline">Start Shopping</Link>
                                    </div>
                                ) : (
                                                                    ...
                                                                    <div key={item.id} className="flex justify-between items-center bg-white p-3 rounded-lg border border-gray-100">
                                                                        <div className="flex items-center gap-4">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <p className="text-xs text-gray-500">Qty: {item.quantity} {item.selectedColor && `• Color: ${item.selectedColor}`}</p>
                                                                            </div>
                                                                        </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    ...
                                    <p className="text-sm text-gray-500 mt-2">
                                        {trackingOrder.status === 'PREPARING' ? 'Your bouquet is currently being arranged by our florists.' :
                                            trackingOrder.status === 'DELIVERED' ? 'Enjoy your flowers!' :
                    ...
                    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-[60]">
                        <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl relative h-[500px] flex flex-col">
                            <div className="flex justify-between items-center mb-4 border-b border-gray-100 pb-3">
                                <div>
                                    <h2 className="text-xl font-bold font-serif">Message Seller</h2>
                                    <p className="text-xs text-gray-500">Order #{messageOrder.id.slice(0, 8)}</p>
                                </div>
                                    ...
                                    messageOrder.messages.map((msg: any) => (
                                        <div key={msg.id} className={`flex flex-col ${msg.isAdmin ? 'items-start' : 'items-end'}`}>
                                            ...
                                            <span className="text-[10px] text-gray-400 mt-1 px-1">
                                                {msg.isAdmin ? 'Laffa Support' : 'Me'} • {new Date(msg.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                                            </span>
                                        </div>
                                    ))
                                ) : (
